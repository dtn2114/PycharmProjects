...
def get_table(filename):
    ...
    data = get_name(data)
    # print_row(data)
    # header = ['Name and Principal Position', '    Year', 'Annual Compensation   Salary (a', 'Annual Compensation   Bonus (b', 'Annual Compensation   Other Annual Compensation (c', 'Long-Term Compensation  Restricted  ',  'Long-Term Compensation Securities Underlying Options/SAR Awards ', 'Long-Term Compensation  LTIP  ', '  All Other  ', 'Title']
    # body = data[1:]
    # print len(header)
    # body = data[1:]
    # print_row(body)
...
if __name__ == '__main__':
    ...
    filename = '/Users/bill/PycharmProjects/BeauSoupTest/textfiles/MOCC/'
    accession_cik = '0000006383-05-000018_6383_1'
